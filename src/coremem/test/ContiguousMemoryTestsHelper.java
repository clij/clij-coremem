...
public class ContiguousMemoryTestsHelper
{
																			...
																			ContiguousMemoryInterface pContiguousMemoryInterface2)
	{
		if (pContiguousMemoryInterface1 instanceof Copyable<?>)
		{
			...
			OffHeapMemoryAccess.setByte(	pContiguousMemoryInterface1.getAddress() + pContiguousMemoryInterface1.getSizeInBytes()
																			/ 2,
																	(byte) 456);
			...
			assertEquals(	(byte) 456,
										OffHeapMemoryAccess.getByte(pContiguousMemoryInterface2.getAddress() + pContiguousMemoryInterface1.getSizeInBytes()
																								/ 2));
																						...
																						ContiguousMemoryInterface pContiguousMemoryInterface2)
	{
		...
		OffHeapMemoryAccess.setByte(	pContiguousMemoryInterface1.getAddress() + 2,
																(byte) 123);

		OffHeapMemoryAccess.setByte(	pContiguousMemoryInterface1.getAddress() + 3,
																(byte) 111);
		...
		if (pContiguousMemoryInterface1 instanceof Copyable<?>)
		{
			...
			assertEquals(	(byte) 123,
										OffHeapMemoryAccess.getByte(pContiguousMemoryInterface2.getAddress() + 4));
			assertEquals(	(byte) 111,
										OffHeapMemoryAccess.getByte(pContiguousMemoryInterface2.getAddress() + 5));
