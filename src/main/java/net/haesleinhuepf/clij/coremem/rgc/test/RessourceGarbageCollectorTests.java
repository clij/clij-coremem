...
import net.haesleinhuepf.clij.coremem.rgc.*;
...
public class RessourceGarbageCollectorTests
{
          ...
          Cleanable
  {
...

    {
      ...
      net.haesleinhuepf.clij.coremem.rgc.RessourceCleaner.register(lClassWithRessource);

      // double[] lGarbage = new double[10000000];
      // lGarbage[12345] = 1;
    }

    static class MyCleaner implements net.haesleinhuepf.clij.coremem.rgc.Cleaner
    {
  ...
  public void testRessourceCleaner() throws InterruptedException
  {
    ...
    for (int i =
         0; i < 10000
                  || net.haesleinhuepf.clij.coremem.rgc.RessourceCleaner.getNumberOfRegisteredObjects() != 0; i++)
    {
      sleep(1);
      if (i % 100 == 0)
        System.gc();
