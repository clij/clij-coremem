...
public class NIOBuffersInteropTests
{
  ...
  public void testByteBuffer()
  {
    ...
    final net.haesleinhuepf.clij.coremem.ContiguousMemoryInterface lContiguousMemory =
                                                      net.haesleinhuepf.clij.coremem.interop.NIOBuffersInterop.getContiguousMemoryFrom(lBuffer);
